		...
		This repo is for the Canbus interface for Speeduino Ecu using the mega2560 boards.

		As they have no onboard canbus this plugin "Beetle" offers the expansion.
